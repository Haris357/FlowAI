...
import { Sparkles, Moon, Sun, ArrowLeft, FileText, UserCheck, CreditCard, ShieldCheck, Lightbulb, Scale, XCircle, Landmark, Mail } from 'lucide-react';
    ...
    <div className="min-h-screen w-full bg-white dark:bg-[#1A1915] font-sans text-slate-900 dark:text-[#EEECE8] selection:bg-brand-100 selection:text-brand-900 overflow-x-hidden text-[15px]">
      ...
      <section className="relative z-10 pb-8">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="bg-slate-50/80 dark:bg-[#232220] border border-slate-200/60 dark:border-[#3D3A37] rounded-xl p-5">
