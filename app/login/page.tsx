...
export default function LoginPage() {
  ...
  const features = [
    { icon: MessageSquare, text: 'Natural language bookkeeping' },
    { icon: BarChart3, text: 'Real-time financial reports' },
    { icon: FileText, text: 'Invoices, bills & more' },
    { icon: Calculator, text: 'Double-entry accounting' },
  ];
    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div className="absolute inset-0">
          <div
            className="absolute top-20 left-20 w-72 h-72 rounded-full blur-3xl animate-pulse-soft"
            style={{ backgroundColor: `${BRAND_COLORS.primary}40` }}
          />
          <div
            className="absolute bottom-20 right-20 w-96 h-96 rounded-full blur-3xl animate-pulse-soft"
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20 w-full">
          <div className="animate-fade-in">
            ...
            <h1 className="text-4xl xl:text-5xl font-bold text-white mb-6 leading-tight">
              Welcome back to
              <span className="block text-white/90">smarter accounting</span>
            </h1>
            <p className="text-xl mb-12 max-w-md text-white/75">
              Continue managing your finances with the power of conversational AI.
            </p>
        ...
        <div className="w-full max-w-md animate-fade-in-up">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600 dark:text-slate-400">
              ...
              <Link href="/signup" className="font-medium transition-colors hover:underline" style={{ color: BRAND_COLORS.primary }}>
                Create one free
              </Link>
            </p>
          </div>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-slate-50 dark:bg-slate-950 text-slate-500 dark:text-slate-400">or sign in with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-slate-300 dark:border-slate-600 transition-colors cursor-pointer"
