      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-12">
            ...
            <div className="hidden md:flex items-center gap-0.5">
              ...
              <span className="px-3.5 py-1.5 text-[13px] font-semibold text-slate-900 dark:text-white rounded-lg">
                Blog
              </span>
            </div>
        ...
        >
          <div className="px-4 py-4 space-y-1">
            ...
            <span className="block px-3 py-2.5 text-sm font-semibold text-slate-900 dark:text-white rounded-lg">
              Blog
            </span>
            <hr className="border-slate-200/60 dark:border-white/[0.06] my-2" />
            <Link href="/signup" className="block text-center mt-1 px-3 py-2.5 text-sm font-semibold text-white rounded-lg bg-gradient-to-r from-brand-500 to-brand-600">
              Get Started Free
            </Link>
          </div>
        </div>
