...
import { getAllChartOfAccounts, type ChartAccount } from '@/lib/chart-of-accounts';
...
export default function CompaniesPage() {
  ...
  const handleCreateCompany = async () => {
    ...
    try {
      ...
      await initializeCompanyAccounts(companyId, newCompany.businessType.toLowerCase());

      // Auto-generate AI accounts from description if provided
      if (newCompany.description.trim().length > 20) {
        try {
